...
namespace FinalGradesProject
{
    internal class DataSource
    {
        ...
        public void Initialize()
        {
            ...
            Students.Add(new Student() { ID = "214927790", Name = "Sara", Password = "11111111" });
            ...
            Students[0].TestGrade= new Grade() { Name = "Tets", ExeNumber = 4, GradeNumber = 99, Comment = "Good" };
            Students[1].TestGrade= new Grade() { Name = "Tets", ExeNumber = 4, GradeNumber = 95, Comment = "Good" };
            Students[2].TestGrade= new Grade() { Name = "Tets", ExeNumber = 4, GradeNumber = 96, Comment = "Good" };
        }
    }
}
